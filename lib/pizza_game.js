  ...
  _createClass(PizzaGame, [{
    ...
    value: function _attachListeners() {
      ...
      document.getElementById('submit').addEventListener('click', function () {
        _this.call(_this._currentSelectVal());
      });
    }
  }, {
    key: '_currentSelectVal',
    value: function _currentSelectVal() {
    ...
    value: function _updateUIEatOptions() {
      ...
      this.eatOptions().forEach(function (option) {
        _this2._select().options[_this2._select().options.length] = new Option(option, option);
      });
